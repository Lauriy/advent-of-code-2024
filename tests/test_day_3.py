from src.day_3 import solve_first, solve_second, parse_mul_instructions

def test_parse_mul_instructions():
...
def test_parse_mul_instructions_with_conditionals():
    ...
    assert parse_mul_instructions("don't()mul(2,4)do()mul(3,5)", check_enabled=True) == 15
    ...
    assert parse_mul_instructions("mul(2,3)don't()mul(4,5)don't()mul(6,7)", check_enabled=True) == 6  # Only first mul
    assert parse_mul_instructions("do()mul(2,3)don't()mul(4,5)do()mul(6,7)", check_enabled=True) == 48  # First and last
    assert parse_mul_instructions("don't()mul(2,3)mul(4,5)do()mul(6,7)", check_enabled=True) == 42  # Only last
